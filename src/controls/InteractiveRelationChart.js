...
jQuery.sap.declare("sap.jaysdk.InteractiveRelationChart");

sap.ui.core.Element.extend("sap.jaysdk.InteractiveRelationChartItem", {
	metadata: {

	}
});
sap.ui.core.Control.extend("sap.jaysdk.InteractiveRelationChart", {
	metadata: {
	...
	onAfterRendering: function() {
		...
		//------------------------------------------
		// Finally Finally Finally !!!  D3 and Jquery code can be run from this point on.... :P :) . Can finally Breathe :P
		//
		//ANY D3 and JQuesry/Javascript code will work. Chart Can be added after this
		var treeData = [{
			"name": "Service 1",
			"parent": "null",
			"children": [{
		...
		// Fix this for the looks
		var bodyId = "#" + this.sParentId; //Passing UI5 element to d3 chart
		var svg = d3.select(bodyId).append("svg")
